  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        ...
        />
        <div className="w-[50%] h-[50%] absolute z-[3] -left-0.5 top-0 rounded-full white__gradient" />
        <div className="w-[50%] h-[50%] absolute z-[0] -left-0.5 bottom-0 rounded-full pink__gradient" />
      </div>
